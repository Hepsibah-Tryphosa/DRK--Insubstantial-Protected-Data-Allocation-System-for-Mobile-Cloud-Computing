...
CREATE DATABASE IF NOT EXISTS lsdss;
USE lsdss;
...
--
-- Definition of table `filereqtoowner`
--

DROP TABLE IF EXISTS `filereqtoowner`;
CREATE TABLE `filereqtoowner` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `fid` varchar(45) NOT NULL,
  `fname` varchar(45) NOT NULL,
  `uid` varchar(45) NOT NULL,
...
/*!40000 ALTER TABLE `filereqtoowner` DISABLE KEYS */;
/*!40000 ALTER TABLE `filereqtoowner` ENABLE KEYS */;
...
--
-- Definition of table `revocation`
--
...
--
-- Dumping data for table `revocation`
--

/*!40000 ALTER TABLE `revocation` DISABLE KEYS */;
/*!40000 ALTER TABLE `revocation` ENABLE KEYS */;
